...
public class SaiDBMigrationHelper {

    public static boolean DEBUG = false;
    private static String TAG = "SaiDBMigrationHelper";
    ...
    public static void migrate(SQLiteDatabase db, Class<? extends AbstractDao<?, ?>>... daoClasses) {
        DLog.e("【The Old Database Version】" + db.getVersion());
    ...
    public static void migrate(Database database, Class<? extends AbstractDao<?, ?>>... daoClasses) {
        DLog.e("【Generate temp table】start");
        generateTempTables(database, daoClasses);
        DLog.e("【Generate temp table】complete");
        ...
        if (listener != null) {
            ...
            DLog.e("【Drop all table by listener】");
            listener.onCreateAllTables(database, false);
            DLog.e("【Create all table by listener】");
        } else {
            dropAllTables(database, true, daoClasses);
            createAllTables(database, false, daoClasses);
        }
        DLog.e("【Restore data】start");
        restoreData(database, daoClasses);
        DLog.e("【Restore data】complete");
    }
