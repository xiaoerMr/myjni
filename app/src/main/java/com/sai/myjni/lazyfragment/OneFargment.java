...
public class OneFargment extends LazyFragment {
    private static final String TAG = "--OneFargment--";


    private static OneFargment fargment;
    public static OneFargment newInstance() {
        if (fargment == null) {
            fargment = new OneFargment();
        }
        return fargment;
    }
