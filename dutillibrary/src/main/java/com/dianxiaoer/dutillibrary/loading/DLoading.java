package com.dianxiaoer.dutillibrary.loading;
...
/**
 * Created by dianxiaoer on 2018/11/19.
 */

public class DLoading extends View {
    ...
    public DLoading(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DLoading(Context context, AttributeSet attrs, int defStyleAttr) {
