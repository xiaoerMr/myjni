...
public class SingleBigTextDialogListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (itemView == null) {
            itemView = (CheckedTextView) LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_choice_big, parent, false);
        }
